...
import { getNewsInfo } from '@/util/news'
...
const submitForm = () => {
    formRef.value.validate(async (valid) => {
        if (valid) {
             await upload('http://localhost:3000/adminapi/news/upNewsInfo', formModel.value)
            // console.log(res);
...
<template>
    <div>
        ...
        <el-breadcrumb :separator-icon="ArrowRight">
            ...
            <el-breadcrumb-item :to="{ path: '/news-manage/newsList' }">新闻列表</el-breadcrumb-item>
        ...
        <el-card>
            <el-form :model="formModel" ref="formRef" :rules="rules" label-width="100px" style="margin-right:110px;">
                ...
                <el-form-item label="内容" prop="content">
                    <Editor :content="formModel.content" @event="handleChange" v-if="formModel.content"></Editor>
                </el-form-item>
